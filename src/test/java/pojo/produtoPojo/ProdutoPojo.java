...
public class ProdutoPojo {
    ...
    public String getProdutoMock() {
        return produtoMock;
    }

    public void setProdutoMock(String produtoMock) {
        this.produtoMock = produtoMock;
    }
